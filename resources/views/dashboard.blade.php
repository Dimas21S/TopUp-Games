...
<body>
  ...
  {{-- Daftar Top Up Game --}}
  <section class="topup-games">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center mb-5">
          <h2 class="section-title" style="font-family: 'Rubik Mono One', monospace;">Top Up Game Populer</h2>
          <p class="text-muted">Nikmati pengalaman bermain game yang lebih seru dengan top up game favorit Anda</p>
        </div>
      </div>
      <div class="row g-4">
        <img src="{{ asset('image/wallpaper-2.jpg') }}" alt="Mobile Legends" class="col-md-6 img-fluid">
        <img src="{{ asset('image/wallpaper-2.jpg') }}" alt="Mobile Legends" class="col-md-6 img-fluid">
      </div>
      <div class="row g-4 mt-4">
        <img src="{{ asset('image/wallpaper-2.jpg') }}" alt="Mobile Legends" class="col-md-4 img-fluid">
        <img src="{{ asset('image/1309595.jpg') }}" alt="Free Fire" class="col-md-4 img-fluid">
        <img src="{{ asset('image/1309771.jpg') }}" alt="PUBG Mobile" class="col-md-4 img-fluid">
      </div>
      <div class="row g-4 mt-4 col-md-10 mx-auto">
        <img src="{{ asset('image/wallpaper-2.jpg') }}" alt="Mobile Legends" class="col-md-6 img-fluid w-50">
        <img src="{{ asset('image/1309595.jpg') }}" alt="Free Fire" class="col-md-6 img-fluid w-50">
      </div>
    </div>
  </section>
  ...
  <section class="follow-us">
    <div class="container text-center">
      <h2 class="section-title" style="font-family: 'Rubik Mono One', monospace;">Ikuti Kami di Media Sosial</h2>
